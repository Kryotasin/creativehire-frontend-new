...
const Step2 = props => {
  ...
  const onValidateForm = async () => {
    ...
    const values = await validateFields();
      ...
      message.loading({ content: 'Please wait while we create your projects...', key: "processing", duration: (values.links.length) * 5000 });
    ...
    Object.keys(values.links).forEach((k) => {
      setTimeout(() => {
        axios.post(REACT_APP_AXIOS_API_V1.concat('project/basicdetails/'), {
          url: values.links[k],
        })
        ...
        .then((res) => {
          ...
          axios.post(REACT_APP_AXIOS_API_V1.concat('project/'), {
  ...
  return (
    <>
      ...
      >
        ...
        <Form.Item name="links" label="Select projects">
